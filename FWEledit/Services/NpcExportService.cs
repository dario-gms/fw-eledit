...
namespace FWEledit
{
    public sealed class NpcExportService
    {
        public FileExportResult ExportNpcNames(eListCollection listCollection, string filePath)
        {
            ...
            if (listCollection.Lists.Length <= 57)
            {
                result.ErrorMessage = "NPC lists not found.";
                return result;
            }
