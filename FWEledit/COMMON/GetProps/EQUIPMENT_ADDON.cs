...
namespace FWEledit
{
    class EQUIPMENT_ADDON
    {
        ...
        private static string GetSkillTokenFromParam(ISessionService sessionService, string param)
        {
        ...
        private static bool TryGetFwAddonText(ISessionService sessionService, int addonType, string param1, string param2, out string text)
        {
            ...
            switch (addonType)
            {
                ...
                case 77:
                case 81:
                    text = "Skill " + GetSkillTokenFromParam(sessionService, param1) + " Lv" + (p2 > 0 ? p2.ToString() : "1");
                    return true;
                case 79:
        ...
        public static string GetAddon(ISessionService sessionService, string id)
        {
            string line = "";
            ...
            try
            {
                ...
                string param2 = "0";
                string param3 = "0";
                //for (int k = 0; k < sessionService.ListCollection.Lists[0].elementValues.Count; k++)
                //{
                int key = int.Parse(id);
                if (!sessionService.ListCollection.addonIndex.ContainsKey(key))
                {
                    return "";
                }
                int k = sessionService.ListCollection.addonIndex[key];
                    if (sessionService.ListCollection.GetValue(0, k, 0) == id)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                addon_type = Convert.ToInt32(sessionService.Database.addonslist[id].ToString());
                                hasAddonType = true;
                            }
                            if (!hasAddonType)
                            {
                            ...
                            {
                                case 0:
                                    line = Extensions.GetLocalization(sessionService, 7202) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 1:
                                    line = Extensions.GetLocalization(sessionService, 7203) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 2:
                                    line = Extensions.GetLocalization(sessionService, 7202) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    ...
                                    break;
                                case 3:
                                    line = Extensions.GetLocalization(sessionService, 7204) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 4:
                                    line = Extensions.GetLocalization(sessionService, 7205) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 5:
                                    line = Extensions.GetLocalization(sessionService, 7204) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 6:
                                    line = Extensions.GetLocalization(sessionService, 7206) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7202) + " -" + param2;
                                    break;
                                case 7:
                                    line = Extensions.GetLocalization(sessionService, 7202) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7206) + " -" + param2;
                                    break;
                                case 8:
                                    line = Extensions.GetLocalization(sessionService, 7204) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7207) + " -" + param2;;
                                    break;
                                case 9:
                                    line = String.Format(Extensions.GetLocalization(sessionService, 7214), "-" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("F2", CultureInfo.CreateSpecificCulture("en-US")));
                                    break;
                                case 10:
                                    line = Extensions.GetLocalization(sessionService, 7213) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("F2", CultureInfo.CreateSpecificCulture("en-US"));
                                    break;
                                case 11:
                                    line = Extensions.GetLocalization(sessionService, 7215) + " -" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 12:
                                    line = Extensions.GetLocalization(sessionService, 7206) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 13:
                                    line = Extensions.GetLocalization(sessionService, 7237) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 14:
                                    line = Extensions.GetLocalization(sessionService, 7207) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 15:
                                    line = Extensions.GetLocalization(sessionService, 7208) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 16:
                                    line = Extensions.GetLocalization(sessionService, 7208) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 17:
                                    line = Extensions.GetLocalization(sessionService, 7209) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 18:
                                    line = Extensions.GetLocalization(sessionService, 7209) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 19:
                                    line = Extensions.GetLocalization(sessionService, 7210) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 20:
                                    line = Extensions.GetLocalization(sessionService, 7210) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 21:
                                    line = Extensions.GetLocalization(sessionService, 7211) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 22:
                                    line = Extensions.GetLocalization(sessionService, 7211) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 23:
                                    line = Extensions.GetLocalization(sessionService, 7212) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 24:
                                    line = Extensions.GetLocalization(sessionService, 7212) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 25:
                                    line = Extensions.GetLocalization(sessionService, 7208) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0") + "\n" + Extensions.GetLocalization(sessionService, 7211) + " -" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 26:
                                    line = Extensions.GetLocalization(sessionService, 7209) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0") + "\n" + Extensions.GetLocalization(sessionService, 7208) + " -" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 27:
                                    line = Extensions.GetLocalization(sessionService, 7210) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0") + "\n" + Extensions.GetLocalization(sessionService, 7212) + " -" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 28:
                                    line = Extensions.GetLocalization(sessionService, 7211) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0") + "\n" + Extensions.GetLocalization(sessionService, 7210) + " -" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 29:
                                    line = Extensions.GetLocalization(sessionService, 7212) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0") + "\n" + Extensions.GetLocalization(sessionService, 7209) + " -" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param2)), 0).ToString("P0");
                                    break;
                                case 30:
                                    line = Extensions.GetLocalization(sessionService, 7208) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7211) + " -" + param2;
                                    break;
                                case 31:
                                    line = Extensions.GetLocalization(sessionService, 7209) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7208) + " -" + param2;
                                    break;
                                case 32:
                                    line = Extensions.GetLocalization(sessionService, 7210) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7212) + " -" + param2;
                                    break;
                                case 33:
                                    line = Extensions.GetLocalization(sessionService, 7211) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7210) + " -" + param2;
                                    break;
                                case 34:
                                    line = Extensions.GetLocalization(sessionService, 7212) + " +" + param1 + "\n" + Extensions.GetLocalization(sessionService, 7209) + " -" + param2;
                                    break;
                                case 35:
                                    line = Extensions.GetLocalization(sessionService, 7217) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 36:
                                    line = Extensions.GetLocalization(sessionService, 7218) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 37:
                                    line = Extensions.GetLocalization(sessionService, 7219) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 38:
                                    line = Extensions.GetLocalization(sessionService, 7220) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 39:
                                    line = Extensions.GetLocalization(sessionService, 7221) + " +" + Convert.ToInt32(param1) / 2;
                                    break;
                                case 40:
                                    line = Extensions.GetLocalization(sessionService, 7222) + " +" + Convert.ToInt32(param1) / 2;
                                    break;
                                case 41:
                                    line = Extensions.GetLocalization(sessionService, 7223) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 42:
                                    line = Extensions.GetLocalization(sessionService, 7224) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 43:
                                    line = Extensions.GetLocalization(sessionService, 7225) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 44:
                                    line = Extensions.GetLocalization(sessionService, 7226) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                    break;
                                case 45:
                                    line = Extensions.GetLocalization(sessionService, 7229) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 46:
                                    line = Extensions.GetLocalization(sessionService, 7227) + " +" + param1;
                                    break;
                                case 47:
                                    line = Extensions.GetLocalization(sessionService, 7227) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 48:
                                    line = String.Format(Extensions.GetLocalization(sessionService, 7230), "+" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("F2", CultureInfo.CreateSpecificCulture("en-US")));
                                    break;
                                case 49:
                                    line = Extensions.GetLocalization(sessionService, 7231) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 50:
                                    line = Extensions.GetLocalization(sessionService, 7228) + " +" + param1;
                                    break;
                                case 51:
                                    line = Extensions.GetLocalization(sessionService, 7228) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");//param1%~param2%
                                    break;
                                case 52:
                                    line = Extensions.GetLocalization(sessionService, 7232) + " +" + param1;
                                    break;
                                case 53:
                                    line = Extensions.GetLocalization(sessionService, 7232) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 54:
                                    line = Extensions.GetLocalization(sessionService, 7233) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 55:
                                    line = Extensions.SkillDesc(sessionService, Convert.ToInt32(param1));
                                    break;
                                case 56:
                                    line = Extensions.GetLocalization(sessionService, 7235) + " -" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 57:
                                    line = Extensions.GetLocalization(sessionService, 7236);
                                    break;
                                case 58:
                                    line = Extensions.GetLocalization(sessionService, 7216) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 59:
                                    line = Extensions.GetLocalization(sessionService, 7239) + " +" + param1;
                                    break;
                                case 60:
                                    line = Extensions.GetLocalization(sessionService, 7240) + " +" + param1;
                                    break;
                                case 61:
                                    line = Extensions.GetLocalization(sessionService, 7238) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 62:
                                    line = Extensions.GetLocalization(sessionService, 7241);
                                    break;
                                case 63:
                                    line = Extensions.GetLocalization(sessionService, 7242) + " +" + param1;
                                    break;
                                case 64:
                                    line = Extensions.GetLocalization(sessionService, 7243) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 65:
                                    line = Extensions.GetLocalization(sessionService, 7244) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 66:
                                    line = Extensions.GetLocalization(sessionService, 7245) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 67:
                                    line = Extensions.GetLocalization(sessionService, 7246) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 68:
                                    line = Extensions.GetLocalization(sessionService, 7247) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 69:
                                    line = Extensions.GetLocalization(sessionService, 7234) + " +" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("P0");
                                    break;
                                case 70:
                                    line = Extensions.GetLocalization(sessionService, 7239) + " +" + param1;
                                    if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                ...
                                case 88:
                                    ...
                                    break;
                                case 89:
                                    line = Extensions.GetLocalization(sessionService, 7200) + " " + id + " " + Extensions.GetLocalization(sessionService, 7201) + " " + addon_type + " " + param1 + "-" + param2 + "-" + param3;
                                    break;
                                case 90:
                                    line = Extensions.GetLocalization(sessionService, 7248) + " +" + param1;
                                    break;
                                case 91:
                                    line = Extensions.GetLocalization(sessionService, 7249) + " +" + param1;
                                    break;
                                case 92:
                                    line = Extensions.GetLocalization(sessionService, 7200) + " " + id + " " + Extensions.GetLocalization(sessionService, 7201) + " " + addon_type + " " + param1 + "-" + param2 + "-" + param3;
                                    //if (Convert.ToInt32(num_params) > 1 && param1 != param2) line += "~" + param2;
                                ...
                                case 114:
                                    ...
                                    break;
                                case 115:
                                    line = String.Format(Extensions.GetLocalization(sessionService, 7050), "+" + BitConverter.ToSingle(BitConverter.GetBytes(Convert.ToInt32(param1)), 0).ToString("F1", CultureInfo.CreateSpecificCulture("en-US")));
                                    break;
                                ...
                                case 156:
                                    ...
                                    break;
                                case 160:
                                    line = Extensions.GetLocalization(sessionService, 7251) + " +" + param1;
                                    break;
                                case 161:
                                    line = Extensions.GetLocalization(sessionService, 7200) + " " + id + " " + Extensions.GetLocalization(sessionService, 7201) + " " + addon_type + " " + param1 + "-" + param2 + "-" + param3;
                                    break;
                                ...
                                case 174:
                                    ...
                                    break;
                                case 175:
                                    line = Extensions.GetLocalization(sessionService, 7252) + " +" + param1;
                                    break;
                                case 176:
                                    line = Extensions.GetLocalization(sessionService, 7253) + " +" + param1;
                                    break;
                                case 200:
                                    line = Extensions.GetLocalization(sessionService, 7200) + " " + id + " " + Extensions.GetLocalization(sessionService, 7201) + " " + addon_type + " " + param1 + "-" + param2 + "-" + param3;
                                    break;
                                ...
                                default:
                                    {
                                        return line = Extensions.GetLocalization(sessionService, 7200) + " " + id + " " + Extensions.GetLocalization(sessionService, 7201) + " " + addon_type + " " + param1 + "-" + param2 + "-" + param3;
                                    }
                            }
                        }
                        catch
                        {
                            line = Extensions.GetLocalization(sessionService, 7200) + " " + id + " " + param1 + "-" + param2 + "-" + param3;
                        }
                    }
